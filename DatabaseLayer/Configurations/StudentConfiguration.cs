...
namespace DatabaseLayer.Configurations
{
    public class StudentConfiguration : IEntityTypeConfiguration<Student>
    {
        ...
        public void Configure(Microsoft.EntityFrameworkCore.Metadata.Builders.EntityTypeBuilder<Student> builder)
        {
            ...
            builder.Property(x => x.Name).IsRequired().HasMaxLength(63);
            builder.Property(x => x.LastName).IsRequired().HasMaxLength(63);
            builder.Property(x => x.Username).IsRequired().HasMaxLength(63);
            builder.Property(x => x.Email).IsRequired().HasMaxLength(255);
            builder.Property(x => x.Deleted).HasDefaultValue(false);
            builder.Property(x => x.Rating).IsRequired();
            builder.Property(x => x.Privilege).IsRequired();
            builder.Property(x => x.Index).IsRequired().HasMaxLength(15);
